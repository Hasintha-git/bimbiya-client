...
import Banner1 from '../image/5.jpg';
import Banner2 from '../image/6.jpg';
import Banner3 from '../image/7.jpg';
import Banner4 from '../image/8.jpg';
import Banner5 from '../image/9.jpg';
...
const images = [
  ...
  { src: Banner3, title: 'Category Title 4', description: 'Category Description 4' },
  { src: Banner5, title: 'Category Title 4', description: 'Category Description 4' },
];

const TrendingFoodcity = () => {
    ...
    Trending Foodcity Item
      ...
      <Slider {...settings}>
        {images.map((image, index) => (
          <div
            key={index}
            className={`w-full md:w-1/5 px-2 relative ${
...
export default TrendingFoodcity;
